...
import { WrapAroundEnding, ZeroCurvatureEnding, ZeroSlopeEnding, LoopRepeat, LoopPingPong, LoopOnce } from '../Three';
	...
	_updateTime: function( deltaTime ) {
		...
		switch ( loop ) {
			...
			case LoopRepeat:
				...
				if ( loop === LoopPingPong && ( loopCount & 1 ) === 1 ) {
