...
THREE$MorphAnimMesh.prototype = Object.create(_Mesh.THREE$Mesh.prototype);
...
THREE$MorphAnimMesh.prototype.updateAnimation = function (delta) {
	...
	var keyframe = this.startKeyframe + _mathMath.THREE$Math.clamp(Math.floor(this.time / frameTime), 0, this.length - 1);
