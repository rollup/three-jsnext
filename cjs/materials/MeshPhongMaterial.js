...
function THREE$MeshPhongMaterial(parameters) {
	...
	this.specular = new _mathColor.THREE$Color(0x111111);
	this.shininess = 30;
	...
	this.normalMap = null;
	this.normalScale = new _mathVector2.THREE$Vector2(1, 1);
...
THREE$MeshPhongMaterial.prototype = Object.create(_Material.THREE$Material.prototype);
