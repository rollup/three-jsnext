...
function THREE$CameraHelper(camera) {
	...
	var material = new _materialsLineBasicMaterial.THREE$LineBasicMaterial({ color: 0xffffff, vertexColors: _Three.THREE$FaceColors });
	...
	function addPoint(id, hex) {
		...
		geometry.colors.push(new _mathColor.THREE$Color(hex));
...
THREE$CameraHelper.prototype = Object.create(_objectsLineSegments.THREE$LineSegments.prototype);
...
THREE$CameraHelper.prototype.update = (function () {
	...
	var camera = new _camerasCamera.THREE$Camera();
