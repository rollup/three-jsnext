...
var _geometriesShapeGeometry = require('../geometries/ShapeGeometry');

var _geometriesExtrudeGeometry = require('../geometries/ExtrudeGeometry');
...
function THREE$Shape() {
	...
	_Path.THREE$Path.apply(this, arguments);
	this.holes = [];
};

THREE$Shape.prototype = Object.create(_Path.THREE$Path.prototype);
...
THREE$Shape.prototype.extrude = function (options) {
	...
	var extruded = new _geometriesExtrudeGeometry.THREE$ExtrudeGeometry(this, options);
	return extruded;
};
...
THREE$Shape.prototype.makeGeometry = function (options) {
	...
	var geometry = new _geometriesShapeGeometry.THREE$ShapeGeometry(this, options);
	return geometry;
};
...
THREE$Shape.Utils = {
	...
	triangulateShape: function (contour, holes) {
		...
		var triangles = _FontUtils.THREE$FontUtils.Triangulate(shapeWithoutHoles, false); // True returns indices for points of spooled shape
	...
	isClockWise: function (pts) {
		...
		return _FontUtils.THREE$FontUtils.Triangulate.area(pts) < 0;
	},
