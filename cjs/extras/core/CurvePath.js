...
THREE$CurvePath.prototype = Object.create(_Curve.THREE$Curve.prototype);
...
THREE$CurvePath.prototype.closePath = function () {
	...
	if (!startPoint.equals(endPoint)) {
		...
		this.curves.push(new _curvesLineCurve.THREE$LineCurve(endPoint, startPoint));
	}
};
...
THREE$CurvePath.prototype.getBoundingBox = function () {
	...
	sum = v3 ? new _mathVector3.THREE$Vector3() : new _mathVector2.THREE$Vector2();
...
THREE$CurvePath.prototype.createGeometry = function (points) {
	...
	for (var i = 0; i < points.length; i++) {
		...
		geometry.vertices.push(new _mathVector3.THREE$Vector3(points[i].x, points[i].y, points[i].z || 0));
	}
