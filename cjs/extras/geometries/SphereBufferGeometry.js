...
function THREE$SphereBufferGeometry(radius, widthSegments, heightSegments, phiStart, phiLength, thetaStart, thetaLength) {
	...
	var positions = new _coreBufferAttribute.THREE$BufferAttribute(new Float32Array(vertexCount * 3), 3);
	var normals = new _coreBufferAttribute.THREE$BufferAttribute(new Float32Array(vertexCount * 3), 3);
	var uvs = new _coreBufferAttribute.THREE$BufferAttribute(new Float32Array(vertexCount * 2), 2);
...
THREE$SphereBufferGeometry.prototype = Object.create(_coreBufferGeometry.THREE$BufferGeometry.prototype);
