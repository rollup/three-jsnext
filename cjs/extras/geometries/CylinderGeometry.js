...
function THREE$CylinderGeometry(radiusTop, radiusBottom, height, radialSegments, heightSegments, openEnded, thetaStart, thetaLength) {
	...
	if (openEnded === false && radiusTop > 0) {
		...
		this.vertices.push(new _mathVector3.THREE$Vector3(0, heightHalf, 0));
		...
		for (x = 0; x < radialSegments; x++) {
			...
			var n1 = new _mathVector3.THREE$Vector3(0, 1, 0);
			var n2 = new _mathVector3.THREE$Vector3(0, 1, 0);
			var n3 = new _mathVector3.THREE$Vector3(0, 1, 0);

			var uv1 = uvs[0][x].clone();
			var uv2 = uvs[0][x + 1].clone();
			var uv3 = new _mathVector2.THREE$Vector2(uv2.x, 0);

			this.faces.push(new _coreFace3.THREE$Face3(v1, v2, v3, [n1, n2, n3], undefined, 1));
	...
	if (openEnded === false && radiusBottom > 0) {
		...
		for (x = 0; x < radialSegments; x++) {
			...
			var uv3 = new _mathVector2.THREE$Vector2(uv2.x, 1);

			this.faces.push(new _coreFace3.THREE$Face3(v1, v2, v3, [n1, n2, n3], undefined, 2));
			this.faceVertexUvs[0].push([uv1, uv2, uv3]);
		}
	}
...
THREE$CylinderGeometry.prototype = Object.create(_coreGeometry.THREE$Geometry.prototype);
