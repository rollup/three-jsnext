...
function THREE$PlaneBufferGeometry(width, height, widthSegments, heightSegments) {
	...
	this.addAttribute('index', new _coreIndexBufferAttribute.THREE$IndexBufferAttribute(indices, 1));
	this.addAttribute('position', new _coreBufferAttribute.THREE$BufferAttribute(vertices, 3));
...
THREE$PlaneBufferGeometry.prototype = Object.create(_coreBufferGeometry.THREE$BufferGeometry.prototype);
