...
THREE$Color.prototype = {
	...
	setHSL: (function () {
		...
		return function (h, s, l) {
			...
			h = _Math.THREE$Math.euclideanModulo(h, 1);
			s = _Math.THREE$Math.clamp(s, 0, 1);
			l = _Math.THREE$Math.clamp(l, 0, 1);
...
exports.THREE$ColorKeywords = THREE$ColorKeywords = { 'aliceblue': 0xF0F8FF, 'antiquewhite': 0xFAEBD7, 'aqua': 0x00FFFF, 'aquamarine': 0x7FFFD4, 'azure': 0xF0FFFF,
