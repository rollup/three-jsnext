...
function THREE$Box3(min, max) {
	...
	this.min = min !== undefined ? min : new _Vector3.THREE$Vector3(Infinity, Infinity, Infinity);
	this.max = max !== undefined ? max : new _Vector3.THREE$Vector3(-Infinity, -Infinity, -Infinity);
};
...
THREE$Box3.prototype = {
	...
	setFromCenterAndSize: (function () {
		...
		var v1 = new _Vector3.THREE$Vector3();
	...
	getBoundingSphere: (function () {
		...
		return function (optionalTarget) {
			...
			var result = optionalTarget || new _Sphere.THREE$Sphere();
	...
	applyMatrix4: (function () {
		...
		var points = [new _Vector3.THREE$Vector3(), new _Vector3.THREE$Vector3(), new _Vector3.THREE$Vector3(), new _Vector3.THREE$Vector3(), new _Vector3.THREE$Vector3(), new _Vector3.THREE$Vector3(), new _Vector3.THREE$Vector3(), new _Vector3.THREE$Vector3()];
